...
A basic implementation of persistent memory using a ${DOCKER_REGISTRY_TAG} knowledge graph. This lets Claude remember information about the user across chats.
